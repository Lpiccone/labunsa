            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" @click="mostrarDetail()" class="btn btn-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr v-for="solicitud in arraySolicitud" :key="solicitud.id_headboards">
                                        <td>
    ...
    export default {
        ...
        methods : {
            listarVenta (page,buscar,criterio){
                let me=this;
                var uri= me.url+'/venta?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            selectProveedor(search,loading){
                ...
                var uri= me.url+'/proveedor/selectProveedor?filtro='+search;
                axios.get(uri).then(function (response) {
            ...
            buscarArticulo(){
                let me=this;
                var uri= me.url+'/articulo/buscarArticulo?filtro=' + me.codigo;
            ...
            listarArticulo (buscar,criterio){
                let me=this;
                var uri= me.url+'/articulo/listarArticulo?buscar='+ buscar + '&criterio='+ criterio;
                axios.get(uri).then(function (response) {
                    var respuesta= response.data;
            ...
            registrarIngreso(){
                ...
                axios.post(me.url+'/ingreso/registrar',{
            ...
            desactivarIngreso(id){
               swal({
                ...
                if (result.value) {
                    ...
                    axios.put(me.url+'/ingreso/desactivar',{
                        'id': id
                    }).then(function (response) {
                        me.listarIngreso(1,'','num_comprobante');
                        swal(
