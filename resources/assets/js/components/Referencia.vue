            ...
            <div class="col-md-8">
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <input name="referencia_name" v-model="referencia_name" id="referencia_name" type="text"/>
                        <label>Documento de Identidad</label>
                        <input name="doi" v-model="doi" id="doi" type="text"/>
                        <label>Telefono</label>
                        <input name="phone" v-model="phone" id="phone" type="text"/>
                        <label>Specialidad</label>
                        <input name="speciality" v-model="speciality" id="speciality" type="text"/>
                        <label>Correo Electronico</label>
                        <input name="email" v-model="email" id="email" type="text"/>
                        <label>Direccion</label>
                        <input name="direction" v-model="direction" id="direction" type="text"/>
                        <button type="button" class="btn btn-primary" @click="storeReferencia()">Guardar</button>
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="referencia in arrayReferencia" :key="referencia.id_referencia">
                                    
                                    <td v-text="referencia.referencia_name"></td>
                                    <td v-text="referencia.doi"></td>
                                    <td v-text="referencia.phone"></td>
                                    <td v-text="referencia.speciality"></td>
                                    <td v-text="referencia.email"></td>
                                    <td v-text="referencia.direction"></td>
                                    <td>
                                        <button type="button" @click="updateReferencia()" class="btn btn-warning btn-sm">
                                          Editar
                                        </button> &nbsp;
                                        <button type="button" @click="destroyReferencia()" class="btn btn-danger btn-sm">
                                          Eliminar
                                        </button>
                                    </td>
                                </tr>                                
    ...
    export default {
        ...
        methods : {
            storeReferencia(){
                ...
                axios.post(me.url+'/referencia/store',{
                    'referencia_name': me.referencia_name,
                    'doi': me.doi,
                    'phone': me.phone,
            ...
            listReferencia(){
                let me=this;
                axios.get(me.url+'/referencia/index').then(function (response) {
            ...
            updateReferencia(){
                let me = this;
                axios.put(me.url+'/referencia/update',{
                    'referencia_name': me.referencia_name,
                    'doi': me.doi,
                    'phone': me.phone,
                    'speciality': me.speciality,
