<template>
    <div class="container">
        <div id="div12" class="row justify-content-center">
            <div class="col-md-8">
                <div class="card card-default">
                    <div class="card-body">
                    <div class="col-md-9">
                      <multiselect
                        v-model="reactivesSeleccionados"
                        :options="reactives"
                        track-by="id_reactive"
                        label="name"
                      ...
                      <input name="unitys" v-model="unitys" id="unitys" type="text"/> 
                      </div>
                      <div class="col-md-9">
                      <label>Observaciones</label>
                      <input name="observations" v-model="observations" id="observations" type="text"/>                       
                      </div>
                      <button type="button" class="btn btn-primary" @click="storeIn()">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
        <div id="div13" class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="In in arrayIn" :key="In.id_in_reactive">
                                    
                                    <td>{{ In.name }}</td>
                                    <td>{{ In.unitys }}</td>
                                    <td>{{ In.updated_at }}</td>
                                    <td>{{ In.observations }}</td>
                                    <td>
                                        <button @click.prevent="abrirModal(In)" class="btn btn-warning btn-sm">
                                          Editar
                                        </button>
                                    </td>
                                    <td>
                                        <button @click.prevent="destroyCategory(arrayIn.id_in_reactive)" class="btn btn-danger btn-sm">
                                          Eliminar
                                        </button>
                                    </td>
                                </tr>                                
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Reactivo</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="name" class="form-control"  readonly="readonly">
                                    </div>
                                    <label class="col-md-3 form-control-label" for="text-input">Unidades</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="unitys" class="form-control" placeholder="Unidades">
                                    </div>
                                    <label class="col-md-3 form-control-label" for="text-input">Observaciones</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="observations" class="form-control" placeholder="Observaciones">
                                    </div>
                                </div>
                                <div v-show="errorIn" class="form-group row div-error">
                                    <div class="text-center text-error">
                                        <div v-for="error in errorMostrarMsjIn" :key="error" v-text="error">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==2" class="btn btn-primary" @click="updateIn()">Actualizar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
...
import Multiselect from 'vue-multiselect'
    export default {
      components: { Multiselect },
        ...
        methods : {
          getReactives: function () {
          axios.get("reactivesget").then(({ data }) => (this.reactives = data));
        },
            storeIn(){
                let me = this;
                axios.post('/in/store',{
                    'unitys': this.unitys,
                    'id_reactive':this.reactivesSeleccionados.id_reactive,
            ...
            abrirModal(data = []){                               
              ...
              this.tipoAccion=2; 
              this.id_in_reactive=data['id_in_reactive'];                        
              this.unitys=data['unitys'];
            ...
            listIn(){
                let me=this;
                axios.get('/in/index').then(function (response) {
                    me.arrayIn = response.data;
                })
                .catch(function (error) {
                    console.log(error);
                });
            ...
            updateIn(){
              let me = this;
                axios.put('/in/update',{
                    'id_in_reactive': this.id_in_reactive,
                    'unitys': this.unitys,
            ...
            destroyIn(id)
            {
              windows.alert('inicio destroy'+id);
                let uri=me.url+`/in/destroy/${id}`;
                 windows.alert(uri);
                axios.delete(uri).then(response => {
                this.arrayIn.splice(this.arrayIn.indexOf(id), 1);
              });
            }
        },
        mounted() {
