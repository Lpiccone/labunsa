        ...
        <div id="div12" class="row justify-content-center">
            <div class="col-md-8">
                <div class="card card-default">
                    <div class="card-body">
                        <label>Nombre</label>
                        <input name="name" v-model="name" id="name" type="number"/>
                        ...
                        <button type="button" class="btn btn-primary" @click="storeOut()">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="reactive in arrayReactives" :key="reactive.id_reactive">
                                    
                                    <td>{{ reactive.name }}</td>
                                    <td>{{ reactive.unitys }}</td>
                                    <td>{{ reactive.id_analysis }}</td>
                                    <td>
                                        <button @click.prevent="abrirModal(reactive.id_in_reactive)" class="btn btn-warning btn-sm">
                                          Editar
                                        </button>
                                    </td>
                                    <td>
                                        <button @click.prevent="destroyreactive(arrayReactives.id_in_reactive)" class="btn btn-danger btn-sm">
                                          Eliminar
                                        </button>
                                    </td>
                                </tr>                                
    ...
    export default {
        ...
        methods : {
            storeOut(){
                ...
                axios.post(me.url+'/reactives/store',{
                    'unitys': me.unitys,
                    'name': me.name,
            ...
            listReactive(){
                let me=this;
                axios.get(me.url+'/reactives/index').then(function (response) {
                    me.arrayReactives = response.data;
                })
                .catch(function (error) {
                    console.log(error);
                });
            ...
            destroyReactive(id)
            {
              windows.alert('inicio destroy'+id);
                let uri=me.url+`/reactives/destroy/${id}`;
                 windows.alert(uri);
                axios.delete(uri).then(response => {
                this.arrayOut.splice(this.arrayOut.indexOf(id), 1);
              });
            }
        },
        mounted() {
