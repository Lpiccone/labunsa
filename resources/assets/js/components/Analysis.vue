        ...
        <div class="row justify-content-center">
                <div class="card card-default">
                      <div class="card-body">
                        ...
                        <input name="id_cash" v-model="id_cash" id="id_cash" type="number"/><br>
                        <label>Nombre Analisis</label>
                        <input name="name_analysis" v-model="name_analysis" id="name_analysis" type="text"/><br>
                        <label>Descripcion</label>
                        <input name="description" v-model="description" id="description" type="text"/><br>
                        <label>Precio</label>
                        <input name="price" v-model="price" id="price" type="text" step="any"/><br>
                        <button type="button" class="btn btn-primary" @click="storeAnalysis()">Guardar</button>
                    </div>
                </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="analysis in arrayAnalysis" :key="analysis.id_analysis">

                                    <td>{{ analysis.id_analysis_category }}</td>
                                    <td>{{ analysis.id_cash }}</td>
                                    <td>{{ analysis.name_analysis }}</td>
                                    <td>{{ analysis.description }}</td>
                                    <td>{{ analysis.price }}</td>

                                    <td>
                                        <button type="button" @click="abrirModal(analysis)" class="btn btn-warning btn-sm">
                                        Editar
                                        </button>
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="id_analysis_category" class="form-control" placeholder="Nombre Categoria">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Codigo Caja</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="id_cash" class="form-control" placeholder="Codigo caja">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Nombre Analisis</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="name_analysis" class="form-control" placeholder="Nombre de Analisis">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="email-input">Descripcion</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="description" class="form-control" placeholder="Descripcion">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="email-input">Precio</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="price" class="form-control" placeholder="Precio">
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==2" class="btn btn-primary" @click="updateAnalysis()">Actualizar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
