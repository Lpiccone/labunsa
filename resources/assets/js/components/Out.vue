            ...
            <div class="col-md-8">
                <div class="card card-default">
                    <div class="card-body">
                        ...
                        <input name="id_reactive" v-model="id_reactive" id="id_reactive" type="number"/>
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="Out in arrayOut" :key="Out.id_out_reactive">
                                    
                                    <td>{{ Out.id_reactive }}</td>
                                    <td>{{ Out.unitys }}</td>
                                    <td>{{ Out.updated_at }}</td>
                                    <td>
                                        <button @click.prevent="abrirModal(In.id_in_reactive)" class="btn btn-warning btn-sm">
                                          Editar
                                        </button>
                                    </td>
                                    <td>
    ...
    export default {
        ...
        methods : {
            storeOut(){
                ...
                axios.post(me.url+'/out/store',{
                    'unitys': me.unitys,
                    'id_reactive':me.id_reactive
            ...
            listOut(){
                let me=this;
                axios.get(me.url+'/out/index').then(function (response) {
                    me.arrayOut = response.data;
                })
                .catch(function (error) {
                    console.log(error);
                });
