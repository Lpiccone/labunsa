            ...
            <div class="col-md-8">
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <label>Codigo Cabecera</label>
                        <input name="id_headboards" v-model="id_headboards" id="id_headboards" type="number"/><br>
                        <label>Codigo Analysis</label>
                        <input name="id_analysis" v-model="id_analysis" id="id_analysis" type="number"/><br>
                        <label>Observacion</label>
                        <input name="observation" v-model="observation" id="observation" type="text"/><br>
                        <label>Precio</label>
                        <input name="price" v-model="price" id="price" type="number" step="any"/><br>
                        <button type="button" class="btn btn-primary" @click="storeDetails()">Guardar</button>
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="details in arrayDetails" :key="details.id_details">
                                    
                                    <td v-text="details.id_headboards"></td>
                                    <td v-text="details.analysis"></td>
                                    <td v-text="details.observation"></td>
                                    <td v-text="details.price"></td>
                                    <td>
                                        <button type="button" @click="updateDetails()" class="btn btn-warning btn-sm">
                                          Editar
                                        </button> &nbsp;
                                        <button type="button" @click="destroyDetails()" class="btn btn-danger btn-sm">
                                          Eliminar
                                        </button>
                                    </td>
                                </tr>                                
    ...
    export default {
        ...
        methods : {
            storeCategory(){
                ...
                axios.post(me.url+'/details/store',{
                    'id_headboards': me.id_headboards,
            ...
            listDetails(){
                let me=this;
                axios.get(me.url+'/details/index').then(function (response) {
                    me.arrayDetails = response.data;
                })
                .catch(function (error) {
                    console.log(error);
                });
            ...
            updateDetails(){
                let me = this;
                axios.put(me.url+'/details/update',{
                    'id_headboards': me.id_headboards,
                    'id_analysis': me.id_analysis,
                    'observation': me.observation,
                    'price': me.price
