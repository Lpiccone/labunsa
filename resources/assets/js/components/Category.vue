            ...
            <div class="col-md-8">
                <div class="card card-default">
                    <div class="card-body">
                        ...
                        <input name="name_category" v-model="name_category" id="name_category" type="text"/>
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="category in arrayCategory" :key="category.id_analysis_category">

                                    <td>{{ category.id_analysis_category }}</td>
                                    <td>{{ category.name_category }}</td>
                                    <td>
                                        <button type="button" @click="abrirModal('category', 'update', category)" class="btn btn-warning btn-sm">
                                          Editar
                                        </button>
                                    </td>
                                    <td>
                                        <button @click.prevent="destroyCategory(arrayCategory.id_analysis_category)" class="btn btn-danger btn-sm">
                                          Eliminar
                                        </button>
                                    </td>
                                </tr>
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="name_category" class="form-control" placeholder="Nombre de categoría">
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==2" class="btn btn-primary" @click="updateCategory()">Actualizar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
    ...
    export default {
        ...
        methods : {
            ...
            storeCategory(){
                ...
                axios.post(me.url+'/category/store',{
                    'name_category': me.name_category
                ...
                switch(modelo) {
                    case 'category':
                    {
                        switch(accion) {
                            ...
                            {
                                this.modal=1;
                                this.tituloModal='Actualizar Cetegory';
                                this.tipoAccion=2;
            ...
            listCategory(){
                let me=this;
                axios.get(me.url+'/category/index').then(function (response) {
            ...
            updateCategory(){
              let me = this;
                ...
                axios.put(this.url+'/category/update',{
            ...
            destroyCategory(id)
            {
              axios.delete(this.url+'/category/destroy')
                .then(response => {
                    this.result.splice(id, 1)
                });
                console.log(this.result);
                axios.delete(uri).then(response => {
                this.arrayCategory.splice(this.arrayCategory.indexOf(id), 1);
              });
            }
        },
        mounted() {
