        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card card-default">
                      <div class="card-body">                          
                          <label>Codigo Detalle</label>
                          <input name="id_details" v-model="id_details" id="id_details" type="number"/>
                          <label>Codigo Parametro</label>
                          <input name="id_parameter" v-model="id_parameter" id="id_parameter" type="number"/>.
                          <label>Observaciones</label>
                          <input name="observations" v-model="observations" id="observations" type="text"/>
                          <button type="button" class="btn btn-primary" @click="storeResult()">Guardar</button>
                      </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="result in arrayResultado" :key="result.id_result">

                                  
                                    <td>{{ result.id_details }}</td>
                                    <td>{{ result.id_parameter }}</td>
                                    <td>{{ result.observations }}</td>
                                    <td>
                                        <button type="button" @click="updateResult()" class="btn btn-warning btn-sm">
                                          Editar
                                        </button>
                                    </td>
                                    <td>
                                        <button type="button" @click="destroyResult()" class="btn btn-danger btn-sm">
                                          Eliminar
                                        </button>
                                    </td>
                                </tr>                                
    ...
    export default {
        ...
        props:['url'],
           methods : {
            storeResult(){
                let me = this;
                axios.post(me.url+'/result/store',{
                    'id_details': me.id_details,
                    'id_parameter': me.id_parameter,
            ...
            listResultado(){
                let me=this;
                axios.get(me.url+'/result/index').then(function (response) {
                    me.arrayResultado = response.datas;
                })
                .catch(function (error) {
                    console.log(error);
                });
            ...
            updateResult(){
                let me = this;
                axios.put(me.url+'/result/update',{
                    'id_details': me.id_details,
                    'id_parameter': me.id_parameter,
                    'observations': me.observations
                }).then(function (response) {
