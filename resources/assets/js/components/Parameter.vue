            ...
            <div class="col-md-8">
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <input name="id_analysis" v-model="id_analysis" id="id_analysis" type="number"/>
                        <label>Nombre</label>
                        <input name="name_parameter" v-model="name_parameter" id="name_parameter" type="text"/>
                        <label>Valor Minimo</label>
                        <input name="value_min" v-model="value_min" id="value_min" type="text"/>
                        <label>Valor Maximo</label>
                        <input name="value_max" v-model="value_max" id="value_max" type="text"/>
                        <label>Unidad</label>
                        <input name="unity" v-model="unity" id="unity" type="text"/>  
                        <button type="button" class="btn btn-primary" @click="storeParameter()">Guardar</button>
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="parameter in arrayParameter" :key="parameter.id_parameter">
                                    
                                    <td v-text="parameter.id_analysis"></td>
                                    <td v-text="parameter.name_parameter"></td>
                                    <td v-text="parameter.value_min"></td>
                                    <td v-text="parameter.value_max"></td>
                                    <td v-text="parameter.unity"></td>
                                    <td>
                                        <button type="button" @click="updateParameter()" class="btn btn-warning btn-sm">
                                          Editar
                                        </button> &nbsp;
                                        <button type="button" @click="destroyParameter()" class="btn btn-danger btn-sm">
                                          Eliminar
                                        </button>
                                    </td>
                                </tr>                                
    ...
    export default {
        ...
        methods : {
            storeParameter(){
                ...
                axios.post(me.url+'/parameter/store',{
                    'id_analysis': me.id_analysis,
                    'name_parameter': me.name_parameter,
                    'value_min': me.value_min,
                    'value_max': me.value_max,
                    'unity': me.unity
            ...
            listParameter(){
                let me=this;
                axios.get(me.url+'/parameter/index').then(function (response) {
                    me.arrayParameter = response.data;
                })
                .catch(function (error) {
                    console.log(error);
                });
            ...
            updateParameter(){
                let me = this;
                axios.put(me.url+'/parameter/update',{
                    'id_analysis': me.id_analysis,
                    'name_parameter': me.name_parameter,
                    'value_min': me.value_min,
                    'value_max': me.value_max,
