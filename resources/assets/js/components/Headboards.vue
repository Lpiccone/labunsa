    ...
    <div class="container">
        <div class="row justify-content-center">
                      ...
                      <div class="col-md-10">
                        ...
                        <multiselect
                        v-model="referenciaSeleccionados"
                        :options="referencias"
                        track-by="id_referencia"
                        label="referencia_name"
                        ...
                        <multiselect
                        v-model="patientSeleccionados"
                        :options="patients"
                        track-by="id_patient"
                        label="last_name_patient"
                        ...
                        <multiselect
                          v-model="analysisSeleccionados"
                          :options="analysis"
                          :multiple="true"
                          :taggable="false"
                          track-by="id_analysis"
                          label="name_analysis"
                          placeholder="Seleccionar Analysis">
                        </multiselect>
                        </div>
                        <div class="col-md-10">
                        <label>Total S/</label>
                        <input name="total" v-model="total" id="total" type="number" step="any"/>S/ {{total=calcularTotal}}
                        </div>
                        <div class="col-md-10">
                        <button type="button" class="btn btn-primary" @click="storeHeadboards()">Guardar</button>
                        </div>
                    </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="headboards in arrayHeadboards" :key="headboards.id_headboards">
                                    
                                    <td v-text="headboards.referencia_name"></td>
                                    <td v-text="headboards.display_name"></td>
                                    <td v-text="headboards.created_at"></td>
                                    <td v-text="headboards.total"></td>
                                    <td>
                                        <button type="button" @click="ImprimirSaldo(headboards)" class="btn btn-warning btn-sm">
                                        PDF
                                        </button>
                                    </td>
                                    <td>
                                        <button type="button" @click="abrirModal(headboards)" class="btn btn-warning btn-sm">
                                        Editar
                                        </button>
                                    </td>
                                    <td>
                                        <button type="button" @click="destroyAnalysis()" class="btn btn-danger btn-sm">
                                          Eliminar
                                        </button>
                                    </td>
                                </tr>                                
    ...
    export default {
      components: { Multiselect },
        data(){
            ...
            id_analysis:0,
            arrayHeadboards:[],
            referenciaSeleccionados: [],
            referencias: [],
            patientSeleccionados: [],
            patients: [],
            analysisSeleccionados: [],
            analysis: [],
            datos: []
            }
        },
        ...
        computed:{
          calcularTotal: function(){
                var total=0;
                for(var i=0;i<this.analysisSeleccionados.length;i++){
                    total=total+Number(this.analysisSeleccionados[i].price);
                }
                return total;
            }
        },
        methods : {
            getReferencias: function () {
              axios.get("referenciasget").then(({ data }) => (this.referencias = data));
            },
            getPatients: function () {
              axios.get("patientsget").then(({ data }) => (this.patients = data));
            },
            getAnalysis: function () {
              axios.get("analysisget").then(({ data }) => (this.analysis = data));
            },
            ImprimirSaldo(headboards = [],analysis = [])
            {
              var $ = require("jquery");
              var arr = [ 1, 2, 3, 4, 5 ];
                $('<iframe>', {name: 'myframe',class: 'printFrame'})
                .appendTo('body')
                .contents().find('body')
                .append(`
                          <style>
                  ...
                  <h4 class="centerText">SOLICITUD</h4>           
                  <table style="width:100%">
                    ...
                    <tr>
                      <td>Paciente</td>
                      <td class="centerText">`+headboards.display_name+`</td>
                    </tr>
                    <tr>
                      <td>Referencia</td>
                      <td class="centerText">`+headboards.referencia_name+`</td>
                    </tr>
                    <tr>
                      <td>Fecha</td>
                      <td class="centerText">`+headboards.created_at+`</td>
                    </tr>     
                    <tr>
                    `+
                    $.each( arr, function( index, value ){
                          var sum = sum+ `<td>`+index+`</td><td class="rightText">`+value+`</td>`;
                          return sum;
                      })
                      +`
                    </tr>    
            ...
            storeHeadboards(){
                let me = this;
                axios.post(this.url+'/headboards/store',{
                    'id_referencia':me.referenciaSeleccionados.id_referencia,
                    'id_patient':me.patientSeleccionados.id_patient,
                    'total':me.total,
                    'datos':me.analysisSeleccionados,
                }).then(function (response) {
                    me.cleanText();
                    me.listHeadboards();
                    me.ImprimirSaldo(me.analysisSeleccionados);
                    console.log(response);
                    console.log(me.analysisSeleccionados);
            ...
            //console.log(data);
            this.modal=1;
            this.tituloModal='Actualizar Headboards';
            this.tipoAccion=2;
